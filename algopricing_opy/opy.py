...
def l111_opy_(l1lllll_opy_):
    ...
    if l11lll1_opy_:
        l1111l1_opy_ = unicode().join(
            [
                unichr(
                    ord(char)
                    - l1lll1l_opy_
                    - (l1ll111_opy_ + l1lll_opy_) % l1l11l1_opy_
                )
                for l1ll111_opy_, char in enumerate(l11l1l_opy_)
            ]
        )
    else:
        l1111l1_opy_ = str().join(
            [
                chr(
                    ord(char)
                    - l1lll1l_opy_
...
license = """Copyright 2014, 2015, 2016, 2017, 2018 Jacques de Hooge, GEATEC engineering, www.geatec.com
...
print(
    l111_opy_(
        u"࠭ࡻࡾࠢࠫࡘࡒ࠯ࠠࡄࡱࡱࡪ࡮࡭ࡵࡳࡣࡥࡰࡪࠦࡍࡶ࡮ࡷ࡭ࠥࡓ࡯ࡥࡷ࡯ࡩࠥࡖࡹࡵࡪࡲࡲࠥࡕࡢࡧࡷࡶࡧࡦࡺ࡯ࡳ࡙ࠢࡩࡷࡹࡩࡰࡰࠣࡿࢂ࠭ࠐ"
    ).format(l1lll1lll_opy_.capitalize(), l111l111_opy_)
)
print(
    l111_opy_(
        u"ࠧࡄࡱࡳࡽࡷ࡯ࡧࡩࡶࠣࠬࡈ࠯ࠠࡈࡧࡤࡸࡪࡩࠠࡆࡰࡪ࡭ࡳ࡫ࡥࡳ࡫ࡱ࡫࠳ࠦࡌࡪࡥࡨࡲࡸ࡫࠺ࠡࡃࡳࡥࡨ࡮ࡥࠡ࠴࠱࠴ࠥࡧࡴࠡࠢ࡫ࡸࡹࡶ࠺࠰࠱ࡺࡻࡼ࠴ࡡࡱࡣࡦ࡬ࡪ࠴࡯ࡳࡩ࠲ࡰ࡮ࡩࡥ࡯ࡵࡨࡷ࠴ࡒࡉࡄࡇࡑࡗࡊ࠳࠲࠯࠲࡟ࡲࠬࠑ"
    )
)
...
def main():
    ...
    def l1111l11_opy_(l111l1ll_opy_, open=False):
        ...
        if open:
            return codecs.open(
                l111l1ll_opy_, encoding=l111_opy_(u"ࠩࡸࡸ࡫࠳࠸ࠨࠓ"), mode=l111_opy_(u"ࠪࡻࠬࠔ")
            )

    def l11ll1ll_opy_(l11ll1l1_opy_, name):
        return l111_opy_(u"ࠫࢀ࠶ࡽࡼ࠳ࢀࡿ࠷ࢃࠧࠕ").format(
            l111_opy_(u"ࠬࡥ࡟ࠨࠖ")
            if name.startswith(l111_opy_(u"࠭࡟ࡠࠩࠗ"))
            else l111_opy_(u"ࠧࡠࠩ࠘")
            if name.startswith(l111_opy_(u"ࠨࡡࠪ࠙"))
            else l111_opy_(u"ࠩ࡯ࠫࠚ"),
    ...
    def scramble(l1111l1_opy_):
        global l1lll_opy_
        if l1ll1111_opy_:
            l11l1l_opy_ = unicode().join(
                [
                    unichr(
                        l1l1llll1_opy_
                        + ord(char)
                        + (l1ll111_opy_ + l1lll_opy_) % l111ll11_opy_
                    )
                    for l1ll111_opy_, char in enumerate(l1111l1_opy_)
                ]
            )
            l1lll11ll_opy_ = unichr(l1lll_opy_)
        else:
            l11l1l_opy_ = str().join(
                [
                    chr(
                        l1l1llll1_opy_
                        + ord(char)
        ...
        l1ll1ll_opy_ = l11l1l_opy_[:-l11lll_opy_] + l11l1l_opy_[-l11lll_opy_:]
    ...
    if len(sys.argv) > 1:
        for l1ll1l11_opy_ in (
            l111_opy_(u"ࠪࡃࠬࠢ"),
            l111_opy_(u"ࠫ࠲࡮ࠧࠣ"),
            l111_opy_(u"ࠬ࠳࠭ࡩࡧ࡯ࡴࠬࠤ"),
        ):
    ...
    l111l11l_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠬࡵࡢࡧࡷࡶࡧࡦࡺࡥࡥࡡࡱࡥࡲ࡫࡟ࡵࡣ࡬ࡰࠬ࠲"),
        l111_opy_(u"࠭࡟ࡼࡿࡢࠫ࠳").format(l1lll1lll_opy_),
    )
    l1lll111l_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠧࡱ࡮ࡤ࡭ࡳࡥ࡭ࡢࡴ࡮ࡩࡷ࠭࠴"), l111_opy_(u"ࠨࡡࡾࢁࡤ࠭࠵").format(l1lll1lll_opy_)
    )
    l1l1ll11l_opy_ = l1llll11_opy_(l111_opy_(u"ࠩࡳࡩࡵ࠾࡟ࡤࡱࡰࡱࡪࡴࡴࡴࠩ࠶"), True)
    l1ll11l1_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠪࡷࡴࡻࡲࡤࡧࡢࡩࡽࡺࡥ࡯ࡵ࡬ࡳࡳࡹࠧ࠷"), l111_opy_(u"ࠫࡵࡿࠠࡱࡻࡻࠫ࠸")
    ).split()
    l1l1l1l1_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠬࡹ࡫ࡪࡲࡢࡩࡽࡺࡥ࡯ࡵ࡬ࡳࡳࡹࠧ࠹"), l111_opy_(u"࠭ࡰࡺࡥࠪ࠺")
    ).split()
    l11l1ll1_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠧࡴ࡭࡬ࡴࡤࡶࡡࡵࡪࡢࡪࡷࡧࡧ࡮ࡧࡱࡸࡸ࠭࠻"), l111_opy_(u"ࠨࠩ࠼")
    ).split()
    l1l11l1l_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠩࡨࡼࡹ࡫ࡲ࡯ࡣ࡯ࡣࡲࡵࡤࡶ࡮ࡨࡷࠬ࠽"), l111_opy_(u"ࠪࠫ࠾")
    ).split()
    l111111l_opy_ = l1llll11_opy_(
        l111_opy_(u"ࠫࡵࡲࡡࡪࡰࡢࡪ࡮ࡲࡥࡴࠩ࠿"), l111_opy_(u"ࠬ࠭ࡀ")
    ).split()
    l1ll11lll_opy_ = l1llll11_opy_(
        l111_opy_(u"࠭ࡰ࡭ࡣ࡬ࡲࡤࡴࡡ࡮ࡧࡶࠫࡁ"), l111_opy_(u"ࠧࠨࡂ")
    ).split()
    l11l11l1_opy_ = [
        l111_opy_(u"ࠨࡽ࠳ࢁ࠴ࢁ࠱ࡾࠩࡃ").format(
            directory.replace(l111_opy_(u"ࠩ࡟ࡠࠬࡄ"), l111_opy_(u"ࠪ࠳ࠬࡅ")), fileName
        )
    ...
    l1llll111_opy_ = [
        l1l1ll11_opy_
        for l1l1ll11_opy_ in l11l11l1_opy_
        if not l1l1ll1l1_opy_(l1l1ll11_opy_)
    ]
    ...
    l1l1l111l_opy_ = re.compile(
        l111_opy_(u"ࠧ࠯ࠬࡾ࠴ࢂ࠴ࠪࠨࡉ").format(l1lll111l_opy_), re.DOTALL
    )
    ...
    l1l11l11_opy_ = (
        re.compile(
            l111_opy_(u"ࡵࠫࢀ࠶ࡽࡼ࠳ࢀࡿ࠷ࢃ࠮ࠫࡁࠧࠫࡌ").format(
        ...
        if l1l1ll11l_opy_
            ...
            l111_opy_(u"ࡲࠨࡽ࠳ࢁࢀ࠷ࡽࡼ࠴ࢀ࠲࠯ࡅࠤࠨࡐ").format(
                l111_opy_(u"ࡳࠤࠫࡃࡁࠧࠧࠪࠤࡑ"), l111_opy_(u"ࡴࠪࠬࡄࡂࠡࠣࠫࠪࡒ"), l111_opy_(u"ࡵࠫࠨ࠭ࡓ")
            ),
            re.MULTILINE,
        )
    )
    ...
    def l1ll111l1_opy_(l1llllll1_opy_):
        ...
        if l1ll1l111_opy_:
            if l111ll1l_opy_.search(string):
                ...
                return l111_opy_(u"ࠨࡷࡱࡗࡨࡸࡡ࡮ࡤ࡯ࡩࢀ࠶ࡽࠡࠪࡾ࠵ࢂ࠯ࠧࡘ").format(
                    l1lll111l_opy_, l1l1ll1l_opy_
                )
        else:
    ...
    l1ll1l11l_opy_ = re.compile(
        l111_opy_(u"ࡴࠪࠬࡠࡸࡵ࡞ࡾࡵࡹࢁࡻࡲࠪࡁࠫࠬࢀ࠶ࡽࠪࡾࠫࡿ࠶ࢃࠩࡽࠪࡾ࠶ࢂ࠯ࡼࠩࡽ࠶ࢁ࠮࠯࡙ࠧ").format(
    ...
    l11l1l1l_opy_ = re.compile(
        l111_opy_(
            u"ࡶࠬ࠭ࠧࠎࠌࠣࠤࠥࠦࠠࠡࠢࠣࡠࡧࠦࠠࠡࠢࠣࠤࠥࠦࠊࠡࠢࠣࠤࠥࠦࠠࠡࠪࡂࠥࢀ࠶ࡽࠪࠢࠣࠤࠏࠦࠠࠡࠢࠣࠤࠥࠦࠨࡀࠣࡾ࠵ࢂ࠯ࠠࠡࠢࠍࠤࠥࠦࠠࠡࠢࠣࠤࡠࡤ࡜ࡥ࡞࡚ࡡࠥࠦࠠࠋࠢࠣࠤࠥࠦࠠࠡࠢ࡟ࡻ࠯ࠦࠠࠡࠢࠣࠤࠥࠐࠠࠡࠢࠣࠤࠥࠦࠠࠩࡁ࠿ࠥࡤࡥࠩࠡࠢࠣࠎࠥࠦࠠࠡࠢࠣࠤࠥ࠮࠿࠽ࠣࡾ࠴ࢂ࠯ࠠࠡࠌࠣࠤࠥࠦࠠࠡࠢࠣࠬࡄࡂࠡࡼ࠳ࢀ࠭ࠥࠦࠊࠡࠢࠣࠤࠥࠦࠠࠡ࡞ࡥࠤࠥࠦࠠࠡࠢࠣࠤࠏࠦࠠࠡࠢࠪࠫࠬࡢ"
        ).format(l1lll1l1l_opy_, l1l1ll1l_opy_),
        re.VERBOSE,
    )
    ...
    l1l1lll1_opy_ = [
        l111_opy_(u"ࠧࡼ࠲ࢀ࠳ࢀ࠷ࡽࠨࡥ").format(l11l1l11_opy_, l1lll1ll1_opy_)
        for l1lll1ll1_opy_ in l111111l_opy_
    ]
    l1lllll11_opy_ = [
        l1ll11l1l_opy_
        for l1ll11l1l_opy_ in l1l1lll1_opy_
        if os.path.exists(l1ll11l1l_opy_)
    ]
    ...
    class l1l1l1lll_opy_:
        def __init__(self):
            for l1lll1l1_opy_ in l1l11l1l_opy_:
                l1ll11ll1_opy_ = l1lll1l1_opy_.replace(
                    l111_opy_(u"ࠪ࠲ࠬࡨ"), l1lll111l_opy_
                )
                try:
                    exec(
                        l111_opy_(
                            u"ࠫࠬ࠭ࠍࠋ࡫ࡰࡴࡴࡸࡴࠡࡽ࠳ࢁࠥࡧࡳࠡࡥࡸࡶࡷ࡫࡮ࡵࡏࡲࡨࡺࡲࡥࠎࠌࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥ࠭ࠧࠨࡩ"
                        ).format(l1lll1l1_opy_),
                        globals(),
                    )
                    ...
                    print(
                        l111_opy_(
                            u"ࠬ࡝ࡡࡳࡰ࡬ࡲ࡬ࡀࠠࡤࡱࡸࡰࡩࠦ࡮ࡰࡶࠣ࡭ࡳࡹࡰࡦࡥࡷࠤࡪࡾࡴࡦࡴࡱࡥࡱࠦ࡭ࡰࡦࡸࡰࡪࠦࡻ࠱ࡿࠪࡪ"
                        ).format(l1lll1l1_opy_)
                    )
    ...
    def l1llll1ll_opy_(l1llll11l_opy_):
        ...
        try:
            ...
            l111llll_opy_ = []
        l11l111l_opy_ = [
            getattr(l1llll11l_opy_, l1ll11ll1_opy_) for l1ll11ll1_opy_ in l1l1lllll_opy_
        ]
        l1lll1l11_opy_ = (l1lll111l_opy_.join(l1l1lllll_opy_)).split(l1lll111l_opy_)
        l1l11lll_opy_ = set(
            [
                entry
                for entry in (l111llll_opy_ + l1lll1l11_opy_)
                if not (
                    entry.startswith(l111_opy_(u"࠭࡟ࡠࠩ࡫"))
                    and entry.endswith(l111_opy_(u"ࠧࡠࡡࠪ࡬"))
                )
            ]
        )
    ...
    for l1l1ll11_opy_ in l1llll111_opy_:
        ...
        l1l1111l_opy_, l11lll1l_opy_ = (
            l1l1l1ll1_opy_.rsplit(l111_opy_(u"ࠩ࠱ࠫ࡮"), 1) + [l111_opy_(u"ࠪࠫ࡯")]
        )[:2]
        ...
        if l11lll1l_opy_ in l1ll11l1_opy_ and not l1l1ll11_opy_ in l1lllll11_opy_:
            ...
            if len(l1ll111ll_opy_) > 0:
                if l111lll1_opy_.search(l1ll111ll_opy_[0]):
                    l111l1l1_opy_ += 1
                    if len(l1ll111ll_opy_) > 1 and l1l11ll1_opy_.search(
                        l1ll111ll_opy_[1]
                    ):
                        l111l1l1_opy_ += 1
                        l1ll1ll1_opy_ = False
            ...
            if l1ll1l111_opy_:
                ...
                l1lll11l1_opy_ = l111_opy_(u"ࠨ࡞ࡱࠫࡴ").join(
                    l1ll111ll_opy_[l111l1l1_opy_:]
                )
            l1lll11l1_opy_ = l1l11l11_opy_.sub(l1lll1ll_opy_, l1lll11l1_opy_)
            l11111ll_opy_ = []
            l1lll11l1_opy_ = l1ll1l11l_opy_.sub(l1ll111l1_opy_, l1lll11l1_opy_)
            l1lll11l1_opy_ = l1l1l11l1_opy_.sub(l11ll11l_opy_, l1lll11l1_opy_)
            l1111lll_opy_ = set(
                re.findall(l11l1l1l_opy_, l1lll11l1_opy_) + [l1l1111l_opy_]
            )
            ...
            l11llll1_opy_ = [
                re.compile(l111_opy_(u"ࡴࠪࡠࡧࢁ࠰ࡾ࡞ࡥࠫࡵ").format(l11111l1_opy_))
                for l11111l1_opy_ in l11l1111_opy_
            ]
            ...
            for l11ll1l1_opy_, l1l1llll_opy_ in enumerate(l1ll11111_opy_):
                l1lll11l1_opy_ = l1l1llll_opy_.sub(
                    l11ll1ll_opy_(l11ll1l1_opy_, l11ll111_opy_[l11ll1l1_opy_]),
                    l1lll11l1_opy_,
                )
            l1l1l111_opy_ = -1
            l1lll11l1_opy_ = l1ll11ll_opy_.sub(l1l1l11ll_opy_, l1lll11l1_opy_)
            l1l11111_opy_ = -1
            l1lll11l1_opy_ = l1ll1ll1l_opy_.sub(l1l1l11l_opy_, l1lll11l1_opy_)
            content = l111_opy_(u"ࠪࡠࡳ࠭ࡶ").join(
                l1ll111ll_opy_[:l111l1l1_opy_] + [l1lll11l1_opy_]
            )
            content = l111_opy_(u"ࠫࡡࡴࠧࡷ").join(
                [
                    line
                    for line in [
                        line.rstrip() for line in content.split(l111_opy_(u"ࠬࡢ࡮ࠨࡸ"))
                    ]
                    if line
                ]
            )
            ...
            for index in range(len(l1lll1111_opy_)):
                try:
                    l1lll1111_opy_[index] = l11ll1ll_opy_(
                        l11ll111_opy_.index(l1lll1111_opy_[index]),
                        l1lll1111_opy_[index],
                    )
                except:
                    pass
            l11lll11_opy_ = l111_opy_(u"ࠧ࠰ࠩࡺ").join(l1lll1111_opy_)
            l1111111_opy_ = (
                l111_opy_(u"ࠨࡽ࠳ࢁࢀ࠷ࡽࠨࡻ")
                .format(l1ll1lll1_opy_, l11lll11_opy_)
                .rsplit(l111_opy_(u"ࠩ࠲ࠫࡼ"), 1)[0]
            )
            l1ll1ll11_opy_ = l1111l11_opy_(
                l111_opy_(u"ࠪࡿ࠵ࢃ࠯ࡼ࠳ࢀ࠲ࢀ࠸ࡽࠨࡽ").format(
                    l1111111_opy_, l1lll111_opy_, l11lll1l_opy_
                ),
                open=True,
            )
            ...
            l1111111_opy_ = (
                l111_opy_(u"ࠫࢀ࠶ࡽࡼ࠳ࢀࠫࡾ")
                .format(l1ll1lll1_opy_, l11lll11_opy_)
                .rsplit(l111_opy_(u"ࠬ࠵ࠧࡿ"), 1)[0]
            )
            l1lll11l_opy_ = l111_opy_(u"࠭ࡻ࠱ࡿ࠲ࡿ࠶ࢃࠧࢀ").format(
                l1111111_opy_, l1l1l1ll1_opy_
            )
