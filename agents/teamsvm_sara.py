...
class Agent(object):
    ...
    def _process_last_sale(self, last_sale, profit_each_team):
        ...
        did_customer_buy_from_me = last_sale[1] == self.this_agent_number #if the last sale was us, we set customer_buy_from_me to true
        did_customer_buy_from_opponent = last_sale[1] == self.opponent_number #if the last sale was not us, we set customer_buy_from_them to true
